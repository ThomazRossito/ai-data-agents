...
O diferencial é simples: o assistente **executa** (via MCPs nativos), respeita regras corporativas declarativas (Constituição, KBs, Skills), e orquestra <!-- INVENTORY:agents_total -->18<!-- /INVENTORY:agents_total --> agentes especialistas em vez de jogar tudo em um único agente genérico.
...
- **<!-- INVENTORY:agents_total -->18<!-- /INVENTORY:agents_total --> agentes**, **<!-- INVENTORY:mcps_registered -->20<!-- /INVENTORY:mcps_registered --> MCPs** (<!-- INVENTORY:mcps_custom -->10<!-- /INVENTORY:mcps_custom --> custom, <!-- INVENTORY:mcps_external -->9<!-- /INVENTORY:mcps_external --> de terceiros), **<!-- INVENTORY:kbs_total -->20<!-- /INVENTORY:kbs_total --> KBs**, **<!-- INVENTORY:skills_total -->51<!-- /INVENTORY:skills_total --> skills**, **<!-- INVENTORY:commands_total -->42<!-- /INVENTORY:commands_total --> slash commands** ✅.
