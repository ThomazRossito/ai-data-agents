...
- A Moonshot pode não suportar /messages/batches (endpoint Anthropic exclusivo).
  Se a chamada batch falhar com 404, este script faz fallback para chamadas
  síncronas individuais — mais lento mas funcional.
- SLA oficial Anthropic: 24h. Em Moonshot síncrona é imediato.
"""
