...
- 🤖 **AI Data Agents** — framework de orquestração multi-agente para dados corporativos com <!-- INVENTORY:agents_total -->25<!-- /INVENTORY:agents_total --> agentes especialistas, integrações nativas Databricks + Fabric via MCP e protocolo DOMA
