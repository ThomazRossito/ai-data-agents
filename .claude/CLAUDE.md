...
nativa via MCP ao **Databricks** e **Microsoft Fabric**. Orquestra <!-- INVENTORY:agents_total -->17<!-- /INVENTORY:agents_total --> agentes especialistas
...
**<!-- INVENTORY:agents_total -->17<!-- /INVENTORY:agents_total --> agentes no registry:** `databricks-engineer`, `databricks-ai`, `fabric-engineer`,
