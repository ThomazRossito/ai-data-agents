...
from data_agents.compression.constants import (
    BASH_TOOLS,
    FILE_TOOLS,
    LIST_TOOLS,
...
from data_agents.compression.metrics import _log_compression_metrics
from data_agents.compression.strategies import (
    _compress_by_chars,
    _compress_by_lines,
