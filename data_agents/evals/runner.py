...
# Phase 7: separar raiz do repo (.parent.parent.parent — onde mora logs/, .env)
# do diretório do pacote (.parent — onde mora canonical_queries.yaml ao lado).
REPO_ROOT = Path(__file__).resolve().parent.parent.parent
PACKAGE_DIR = Path(__file__).resolve().parent
DEFAULT_QUERIES_PATH = PACKAGE_DIR / "canonical_queries.yaml"
