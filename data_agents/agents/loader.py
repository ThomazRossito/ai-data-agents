...
from data_agents.mcp_servers.context7.server_config import CONTEXT7_MCP_TOOLS
...
from data_agents.mcp_servers.fabric_notebook.server_config import (
    FABRIC_NOTEBOOK_MCP_TOOLS,
    FABRIC_NOTEBOOK_MCP_READONLY_TOOLS,
)
from data_agents.mcp_servers.fabric_onelake.server_config import (
    FABRIC_ONELAKE_MCP_TOOLS,
    FABRIC_ONELAKE_MCP_READONLY_TOOLS,
)
from data_agents.mcp_servers.fabric_semantic.server_config import (
    FABRIC_SEMANTIC_MCP_TOOLS,
    FABRIC_SEMANTIC_MCP_READONLY_TOOLS,
)
from data_agents.mcp_servers.fabric_sql.server_config import FABRIC_SQL_MCP_TOOLS
from data_agents.mcp_servers.firecrawl.server_config import FIRECRAWL_MCP_TOOLS
from data_agents.mcp_servers.github.server_config import (
    GITHUB_MCP_TOOLS,
    GITHUB_MCP_READONLY_TOOLS,
)
from data_agents.mcp_servers.memory_mcp.server_config import (
    MEMORY_MCP_TOOLS,
...
# Phase 7: kb/ vive na raiz do repo; este arquivo está em data_agents/agents/loader.py,
# então 3 níveis acima para chegar à raiz (.parent.parent.parent).
KB_BASE_DIR = Path(__file__).parent.parent.parent / "kb"

# Diretório base das Skills operacionais (também na raiz do repo)
...
def load_agent(
    ...
    # Phase 7: arquivo em data_agents/agents/loader.py → raiz é 3 níveis acima.
