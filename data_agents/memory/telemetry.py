...
# Phase 7: arquivo em data_agents/memory/telemetry.py — logs/ está na raiz do repo (3 níveis acima).
_LOG_PATH = Path(__file__).parent.parent.parent / "logs" / "memory_usage.jsonl"
