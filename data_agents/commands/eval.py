...
# Phase 7: arquivo em data_agents/commands/eval.py — logs/ está na raiz do repo (3 níveis acima).
_EVALS_PATH = Path(__file__).parent.parent.parent / "logs" / "evals.jsonl"
